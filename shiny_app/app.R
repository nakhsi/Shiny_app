...
# === Load data & model ===
train_data_global <- read.csv("blood_train_data.csv", check.names = FALSE)
train_data_global2 <- read.csv("urine_train.csv", check.names = FALSE)
glmnet_model_blood <- readRDS("blood_model_glm.rds")
rf_model_urine <- readRDS("urine_model_rf.rds")
